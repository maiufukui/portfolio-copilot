...
| Deliverable                              | Code Location                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Test dataset                             | `eval_dataset.json` (11 locked questions, hand-curated against real filings/transcripts for the 4 tracked tickers; 12 originally, Q13 removed 2026-07-27 as a descoped use case, see PRD Task 1 §4).                                                                                                                                                                                                                                                                                                       |
| Evaluation harness                       | `run_eval.py` (`load_dataset:75`, `run_rag_q1:108`, `run_rag_q5:131`, `score_rag_question:212`, `run_tool_question:305` — RAGAS triad + custom PASS/FAIL judge dispatch). Per-question harnesses: `test_q2.py`, `test_q5.py`, `test_q7.py`, `test_q7_grounding.py`, `test_q8.py`, `test_q9.py`, `test_q11.py`. Consolidated scorecard: `run_scorecard.py:231` (`build_scorecard`) → `eval_scorecard.json`. |
...
| Change to another piece of the solution, evidence via the eval harness | **Change** (Q9 filings-relevance guard): `app/graph.py:326` (`FilingsRelevance` classifier), `app/graph.py:352` (`_question_needs_filings_check`). Evidence: `test_q9.py:132` (`run_case`), re-run confirms all 3 judge criteria pass. Live in the current codebase, unaffected by any later change. (A second change, Q13's narrative decoupling, was previously documented here; removed 2026-07-27 along with Q13 itself -- see PRD Task 1 §4 and Task 6 §3.) |
...
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Loom demo video (≤10 min)                    | [https://www.loom.com/share/7c94995f760d445db05bff79efc6561e](https://www.loom.com/share/7c94995f760d445db05bff79efc6561e) |
